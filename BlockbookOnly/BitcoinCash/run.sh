...
exec ./blockbook -sync -blockchaincfg=/home/blockbook/build/blockchaincfg.json -debug -workers=${WORKERS:-1} -public=:${BLOCKBOOK_PORT:-9131} -logtostderr